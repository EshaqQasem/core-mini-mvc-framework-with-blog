              ...
              <div class="box box-danger" id="users-list">
                ...
                <div class="box-body">
                  ...
                  <table class="table table-bordered">
                    ...
                    <?php foreach ($groups AS $users_group) { ?>
                        <tr>
                          <td><?php echo $users_group->id;?></td>
                          <td><?php echo $users_group->name;?></td>
                          <td>
                            <button type="button" data-target="<?php echo url('admin/users-groups/edit/' . $users_group->id) ?>"
                                    data-modal-target="#edit-users-group-<?php echo $users_group->id; ?>" class="btn btn-primary open-popup">
                                Edit
