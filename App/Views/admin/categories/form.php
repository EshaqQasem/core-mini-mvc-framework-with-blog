  <div class="modal fade" id="<?php echo $target; ?>" tabindex="-1"
        ...
        <div class="modal-body">
            ...
            <div class="form-group col-sm-6">
              ...
              <input type="text" class="form-control" name="name" id="category-name"
                     value="<?php echo $name; ?>" placeholder="Category Name">
            </div>

                <div class="form-group col-sm-6">
                    <label for="parent-category">Category Parent</label>
                    <select class="form-control" id="parent-category" name="categoryParent">
                        <option value="0">Main </option>
                        <?php
                        foreach ($cats as $cat){
                            ?>
                        <option value="<?=$cat->id?>"  <?= ($cat->id==$categoryParent)?'selected':'' ?> >
                            <?=$cat->name?> </option>
                        <?php
                        }
                        ?>
