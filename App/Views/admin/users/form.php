      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group col-sm-6">
              ...
              <select name="users_group_id" class="form-control" id="users_group_id">
                <?php foreach ($users_groups AS $users_group) { ?>
                    <option value="<?php echo $users_group->id; ?>" <?php echo $users_group->id == $users_group_id ? 'selected' : false; ?>>
                        <?php echo $users_group->name; ?></option>
                <?php } ?>
              </select>
            </div>
            ...
            <div class="form-group col-sm-6">
                ...
                <input type="date" name="birthday" placeholder="Birth Day" class="form-control"
